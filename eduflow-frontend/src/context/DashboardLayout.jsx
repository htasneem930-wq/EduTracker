...
const DashboardLayout = ({ children }) => {
  ...
  const menuItems = {
    ADMIN: [
      ...
      { to: "/classes", label: "Classes & Subjects", icon: <BookOpen size={20} /> },
    ],
    TEACHER: [
      { to: "/teacher", label: "Dashboard", icon: <LayoutDashboard size={20} /> },
      { to: "/students", label: "My Students", icon: <GraduationCap size={20} /> },
      { to: "/attendance", label: "Attendance", icon: <CalendarCheck size={20} /> },
      { to: "/marks", label: "Marks System", icon: <BarChart3 size={20} /> },
    ],
    STUDENT: [
      { to: "/student", label: "My Performance", icon: <LayoutDashboard size={20} /> },
      { to: "/report", label: "Report Card", icon: <BookOpen size={20} /> },
    ]
  };
